...
const ColorWheelGraphPage = () => (<StyledCWGPage>
    ...
    <MathJax.Node formula={'1 + 2 + 3 + ...=-\\frac{1}{12}'}/>
    ...
    <MathJax.Node formula={partialSums}/>
    ...
    <MathJax.Node formula={'1 - 2 + 3 - 4 + ... = \\frac{1}{(1 + 1)^2}'}/>
    ...
    <MathJax.Node formula={'1 - 2x + 3x^2 - 4x^3 + ... = \\frac{1}{(1 + x)^2},'}/>
